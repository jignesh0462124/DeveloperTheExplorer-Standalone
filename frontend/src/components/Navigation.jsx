...
const Navigation = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 bg-white shadow-sm z-50 ">
      <div className="max-w-7xl mx-auto lg:ms-62 px-4 sm:px-6 lg:px-20">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center md:space-x-4 ms-0">
            <a
              href="#about"
              className="text-sm text-gray-600 hover:text-gray-900 lg:mx-12"
            >
              About
            </a>
            <a
          ...
          {/* CTA Button */}
          <button className="hidden md:block px-4  py-2.5 bg-blue-500 text-white text-sm font-medium rounded-full hover:bg-blue-600 transition">
            Coming Soon
          </button>
