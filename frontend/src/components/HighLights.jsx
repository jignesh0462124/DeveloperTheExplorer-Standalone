...
`,
    ...
    },
    {
      ...
      speakers: [
        ...
        { name: "Sanika Wazarkar", linkedin: "https://www.linkedin.com/in/sanika-wazarkar-6a4448352/", image: "images/san.png", designation: "UI/UX Design Head" },
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-5 sm:gap-6 lg:gap-8">
              {pastEvents.map((event, index) => (
                <div
                  ...
                  className={`highlights-card cursor-pointer rounded-2xl shadow-md sm:shadow-lg p-6 sm:p-7 lg:p-8 bg-white hover:shadow-xl hover:scale-[1.02] active:scale-95 transition-all duration-300 ease-out ${isRevealed
                ...
                >
                  <div className="flex items-center space-x-2 mb-3 sm:mb-4">
                    <div
                      className={`w-3 h-3 rounded-full ${event.color === "pink"
                          ? "bg-pink-500"
                          : "bg-orange-500"
                        }`}
                    />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6 lg:gap-8">
              {currentEvents.map((event, index) => (
                ...
                >
                  <div className="flex items-center space-x-2 mb-3 sm:mb-4">
                    <div
                      className={`w-3 h-3 rounded-full ${event.color === "green" ? "bg-green-500" :
            ...
            <div className="p-6 sm:p-8 border-b border-gray-100 flex justify-between items-start bg-gray-50/50">
              <div>
                <div className="flex items-center space-x-3 mb-2">
                  <span className={`px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider text-white ${selectedEvent.color === "pink" ? "bg-pink-500" :
