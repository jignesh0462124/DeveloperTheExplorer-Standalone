    ...
    return ( 
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className={`highlights-title  text-4xl lg:text-5xl font-bold text-gray-900 mb-4 ${fadeUp}`}>
              Highlights from Our Journey
            </h2>
            <p className={`highlights-subtitle  text-xl text-gray-600 ${fadeUp}`} style={{ transitionDelay: "120ms" }}>
          ...
          {/* Past Events */}
          <div className="mb-12">
            <div className={`highlights-badge  inline-block px-6 py-2 bg-gray-200 rounded-full mb-8 ${fadeUp}`} style={{ transitionDelay: "160ms" }}>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                <div
                  key={index}
                  className={`highlights-card rounded-2xl shadow-lg p-8 hover:shadow-xl transition-all duration-700 ease-out ${
                    isRevealed ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
                  }`}
          ...
          {/* Current Events */}
          <div>
            <div className={`highlights-badge mt-20  inline-block px-6 py-2 bg-blue-500 rounded-full mb-8 ${fadeUp}`} style={{ transitionDelay: "240ms" }}>
